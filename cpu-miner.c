...
static void *miner_thread(void *userdata)
{
	...
	while (1)
	{
		...
		case ALGO_SHA256:
			rc = scanhash_sha256(thr_id, work.data, work.target,
													 max_nonce, &hashes_done);
			break;

		case ALGO_SHA256ET10:
			rc = scanhash_sha256ET10(thr_id, work.data, work.target,
															 max_nonce, &hashes_done);
			break;
